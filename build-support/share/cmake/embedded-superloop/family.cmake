...
define_property(TARGET PROPERTY FAMILY_NAMESPACE INHERITED BRIEF_DOCS "The family namespace of the chips within the vendor namespace")
...
function(add_family)
    set(options "")
    set(singles FAMILY NAMESPACE VENDOR CORTEX_M ARCHITECTURE PRECISION)
    ...
    required(ARG_FAMILY ARG_NAMESPACE ARG_VENDOR ARG_CORTEX_M ARG_ARCHITECTURE ARG_PRECISION)
    ...
    target_compile_definitions(${LOCAL_TARGET} INTERFACE ${ARG_DEFINES} FAMILY=${ARG_FAMILY} FAMILY_NAMESPACE=${ARG_NAMESPACE} CORTEX_M=${ARG_CORTEX_M})
    ...
    set_target_properties(${LOCAL_TARGET} PROPERTIES
        ...
        FAMILY_NAMESPACE ${ARG_NAMESPACE} # The family namespace of the chips
