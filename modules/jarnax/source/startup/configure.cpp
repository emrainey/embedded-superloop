...
void configure(void) {
    ...
    jarnax::print("CPUID: CortexM Revision:%u PartNumber:%u Variant:%u Implementor:%u\r\n", cpu_id.parts.revision, cpu_id.parts.part_number, cpu_id.parts.variant, cpu_id.parts.implementer);
