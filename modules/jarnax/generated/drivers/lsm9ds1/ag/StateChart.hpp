...
/// @file
/// Generated LSM9DS1 Accelerometer/Gyroscope State Chart
...
static_assert(
    NumberOfStates < (std::numeric_limits<std::uint32_t>::max() - 2U), "The number of States can not exceed the max minus 2 (for reserved names)"
);
