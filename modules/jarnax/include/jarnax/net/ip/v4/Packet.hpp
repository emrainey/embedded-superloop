...
public:
    ...
    public:
        ...
        bool IsValid() const {
            // A simple validation check for the IPv4 header
            return (version == 4U) and (IHL == 5U) and (time_to_live > 0U);
        }
    };
    ...
    union {
        ...
        uint16_t words[10];    ///< The IPv4 header represented as an array of 16-bit words for easy access and manipulation.
    };
    union {
