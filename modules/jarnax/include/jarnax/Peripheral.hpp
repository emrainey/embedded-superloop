#ifndef JARNAX_PERIPHERAL_HPP
#define JARNAX_PERIPHERAL_HPP
...
// @TODO should this be defined in Cortex M headers?
...
/// @param rhs
/// @return
constexpr bool operator==(jarnax::Peripheral const& lhs, jarnax::Peripheral const& rhs) {
