...
public:
    ...
    virtual jarnax::dma::Resource_<DERIVED_TYPE>* Assign(Peripheral const& peripheral) = 0;
    ...
    virtual jarnax::dma::Resource_<DERIVED_TYPE>* Acquire(size_t index, Peripheral const& peripheral = _) = 0;
    ...
    virtual core::Status Release(jarnax::dma::Resource_<DERIVED_TYPE>*& resource) = 0;
