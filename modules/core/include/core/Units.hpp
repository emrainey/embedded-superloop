...
#include "core/units/Pascals.hpp"
...
/// @brief The unit of Time is Seconds
using Time = Seconds;
/// @brief The unit of Temperature is Celsius
...
/// @brief Quote Operator for Pascals
/// @param value The value to convert
/// @return The Pascals value
constexpr Pascals operator""_Pa(long double value) {
    return Pascals{static_cast<Pascals::StorageType>(value)};
}

/// @brief Quote Operator for hecto Pascals
/// @param value The value to convert
/// @return The hecto Pascals value
constexpr Pascals operator""_hPa(long double value) {
    return Pascals{static_cast<Pascals::StorageType>(value) * 100.0F};
}

/// @brief Quote Operator for Celsius
/// @param value The value to convert
