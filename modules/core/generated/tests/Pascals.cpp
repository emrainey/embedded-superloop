...
TEST_CASE("Units - Pascals") {
    using namespace core::units;
    Pascals v1{1.0f};
    Pascals v2{2.0f};

    static_assert(std::is_same<core::units::Pascals::StorageType, float>::value, "Storage type should be float");
