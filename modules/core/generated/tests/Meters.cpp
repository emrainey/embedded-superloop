...
TEST_CASE("Units - Meters") {
    using namespace core::units;
    Meters v1{1.0f};
    Meters v2{2.0f};

    static_assert(std::is_same<core::units::Meters::StorageType, float>::value, "Storage type should be float");
