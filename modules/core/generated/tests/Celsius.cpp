...
TEST_CASE("Units - Celsius") {
    using namespace core::units;
    Celsius v1{1.0f};
    Celsius v2{2.0f};

    static_assert(std::is_same<core::units::Celsius::StorageType, float>::value, "Storage type should be float");
