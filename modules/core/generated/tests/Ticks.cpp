...
TEST_CASE("Units - Ticks") {
    using namespace core::units;
    Ticks v1{1U};
    Ticks v2{2U};

    static_assert(std::is_same<core::units::Ticks::StorageType, uint32_t>::value, "Storage type should be uint32_t");
    ...
    //    Ticks volatile v3{7U};
    //    Ticks const v4{v3};
    //    REQUIRE(v4.value() == 7U);
    // }

    // SECTION("Const Construct from Const Volatile") {
    //     Ticks const volatile v3{7U};
    //     Ticks const v4{v3};
    //     REQUIRE(v4.value() == 7U);
    // }
