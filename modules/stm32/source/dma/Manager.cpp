...
#include "stm32/dma/Driver.hpp"
    ...
    // clang-format off
    constexpr static jarnax::Peripheral dma_endpoints[stm32::registers::NumberOfDmaControllers][dma::Driver::NumStreamsPerController][dma::Driver::NumChannelsPerStream] = {
        {{// Stream 0
        SPI3_RX,
        I2C1_RX,
        TIM4_CH1,
