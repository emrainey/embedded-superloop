...
#ifndef STM32_PERIPHERALS_UNIVERSALASYNCHRONOUSRECEIVERTRANSMITTER4__HPP_
#define STM32_PERIPHERALS_UNIVERSALASYNCHRONOUSRECEIVERTRANSMITTER4__HPP_

/// @file
/// Auto Generated Structure Definitions for UniversalAsynchronousReceiverTransmitter from the Peripheralyzer.
/// @copyright
...
/// Universal synchronous asynchronous receiver transmitter (UART4)
struct UniversalAsynchronousReceiverTransmitter final {
    /// Status register (SR)
    struct Status final {
        /// Default Constructor
        Status()
...
static_assert(std::is_standard_layout<UniversalAsynchronousReceiverTransmitter>::value, "Must be standard layout");
// Ensure the offsets are all correct
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, status) == 0x0UL, "Must be located at this offset");
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, data) == 0x4UL, "Must be located at this offset");
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, baudrate) == 0x8UL, "Must be located at this offset");
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, control1) == 0xcUL, "Must be located at this offset");
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, control2) == 0x10UL, "Must be located at this offset");
static_assert(offsetof(UniversalAsynchronousReceiverTransmitter, control3) == 0x14UL, "Must be located at this offset");
...
#endif    // STM32_PERIPHERALS_UNIVERSALASYNCHRONOUSRECEIVERTRANSMITTER4__HPP_
