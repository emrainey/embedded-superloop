...
struct Control1 final {
    ...
    Control1(Control1 volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    Control1(Control1 const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    Control1(Control1&&) = delete;
    /// Parameterized Constructor for constant references
    explicit Control1(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit Control1(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~Control1() = default;
    ...
    inline void operator=(Control1 volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(Control1 const& other) volatile {
        whole = other.whole;
    }
...
struct Control2 final {
    ...
    Control2() : whole{0u} {}
    /// Copy Constructor from volatile
    Control2(Control2 volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    Control2(Control2 const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    Control2(Control2&&) = delete;
    /// Parameterized Constructor for constant references
    explicit Control2(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit Control2(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~Control2() = default;
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(Control2 volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(Control2 const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct Status final {
    ...
    Status() : whole{0u} {}
    /// Copy Constructor from volatile
    Status(Status volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    Status(Status const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    Status(Status&&) = delete;
    /// Parameterized Constructor for constant references
    explicit Status(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit Status(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~Status() = default;
...
struct Data final {
    ...
    Data() : whole{0u} {}
    /// Copy Constructor from volatile
    Data(Data volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    Data(Data const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    Data(Data&&) = delete;
    /// Parameterized Constructor for constant references
    explicit Data(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit Data(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~Data() = default;
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(Data volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(Data const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct CrcPolynomial final {
    ...
    /// Default Constructor
    CrcPolynomial() : whole{0u} {}
    /// Copy Constructor from volatile
    CrcPolynomial(CrcPolynomial volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    CrcPolynomial(CrcPolynomial const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    CrcPolynomial(CrcPolynomial&&) = delete;
    /// Parameterized Constructor for constant references
    explicit CrcPolynomial(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit CrcPolynomial(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(CrcPolynomial volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(CrcPolynomial const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct ReceiveCRC final {
    ...
    ReceiveCRC() : whole{0u} {}
    /// Copy Constructor from volatile
    ReceiveCRC(ReceiveCRC volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    ReceiveCRC(ReceiveCRC const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    ReceiveCRC(ReceiveCRC&&) = delete;
    /// Parameterized Constructor for constant references
    explicit ReceiveCRC(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit ReceiveCRC(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~ReceiveCRC() = default;
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(ReceiveCRC volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(ReceiveCRC const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct TransmitCRC final {
    ...
    /// Default Constructor
    TransmitCRC() : whole{0u} {}
    /// Copy Constructor from volatile
    TransmitCRC(TransmitCRC volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    TransmitCRC(TransmitCRC const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    TransmitCRC(TransmitCRC&&) = delete;
    /// Parameterized Constructor for constant references
    explicit TransmitCRC(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit TransmitCRC(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ~TransmitCRC() = default;
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(TransmitCRC volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(TransmitCRC const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct InterIntegratedCircuitSoundConfiguration final {
    ...
    /// Default Constructor
    InterIntegratedCircuitSoundConfiguration() : whole{0u} {}
    /// Copy Constructor from volatile
    InterIntegratedCircuitSoundConfiguration(InterIntegratedCircuitSoundConfiguration volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    InterIntegratedCircuitSoundConfiguration(InterIntegratedCircuitSoundConfiguration const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    InterIntegratedCircuitSoundConfiguration(InterIntegratedCircuitSoundConfiguration&&) = delete;
    /// Parameterized Constructor for constant references
    explicit InterIntegratedCircuitSoundConfiguration(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit InterIntegratedCircuitSoundConfiguration(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(InterIntegratedCircuitSoundConfiguration volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(InterIntegratedCircuitSoundConfiguration const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
...
struct InterIntegratedCircuitSoundPrescaler final {
    ...
    /// Default Constructor
    InterIntegratedCircuitSoundPrescaler() : whole{0u} {}
    /// Copy Constructor from volatile
    InterIntegratedCircuitSoundPrescaler(InterIntegratedCircuitSoundPrescaler volatile const& other) : whole{other.whole} {}
    /// Copy Construction from nonvolatile
    InterIntegratedCircuitSoundPrescaler(InterIntegratedCircuitSoundPrescaler const& other) : whole{other.whole} {}
    /// Move Constructor is deleted
    InterIntegratedCircuitSoundPrescaler(InterIntegratedCircuitSoundPrescaler&&) = delete;
    /// Parameterized Constructor for constant references
    explicit InterIntegratedCircuitSoundPrescaler(uint32_t const& value) : whole{value} {}
    /// Parameterized Constructor for volatile references
    explicit InterIntegratedCircuitSoundPrescaler(uint32_t volatile& value) : whole{value} {}
    /// Destructor is empty
    ...
    /// Assignment from a volatile to a non volatile copy of the register.
    /// @note Does not return a reference
    inline void operator=(InterIntegratedCircuitSoundPrescaler volatile& other) {
        whole = other.whole;
    }
    /// Assignment from a non volatile to a volatile register
    /// @note Does not return a reference
    inline void operator=(InterIntegratedCircuitSoundPrescaler const& other) volatile {
        whole = other.whole;
    }
    /// Copy Assign a complete value from the base type uint32_t into a volatile version
    /// This allows you to assign the whole register to a literal value or a known constant of the same type.
