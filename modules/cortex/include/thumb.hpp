...
/// Disables Interrupts
__attribute__((always_inline)) inline void initialize(void) {
#if defined(__arm__)
    asm volatile(
        "mov r0, #0 \r\n"
        "mov r1, #0 \r\n"
...
/// Disables Interrupts
__attribute__((always_inline)) inline void disable(void) {
#if defined(__arm__)
...
/// Enables Interrupts
__attribute__((always_inline)) inline void enable(void) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline void breakpoint(void) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline void instruction_barrier(void) {
#if defined(__arm__)
    asm volatile("isb sy" :::);
#endif
}
...
__attribute__((always_inline)) inline void data_memory_barrier(void) {
#if defined(__arm__)
    asm volatile("dmb" :::);
#endif
}
...
__attribute__((always_inline)) inline void data_synchronization_barrier(void) {
#if defined(__arm__)
    asm volatile("dsb" :::);
#endif
}
...
__attribute__((always_inline)) inline void wait_for_event_mode(void) {
#if defined(__arm__)
    asm volatile("wfe" :::);
#endif
}
...
__attribute__((always_inline)) inline std::uint32_t supervisor(Stacked* stacked) {
...
__attribute__((always_inline)) inline void stacks(void* main_stack, void* process_stack) {
#if defined(__arm__)
    asm volatile(
        "msr msp, %0 \r\n"
        "msr psp, %1 \r\n"
...
__attribute__((always_inline)) inline void set_control(cortex::word value) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline void save_callee_registers(void) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline void restore_callee_registers(void) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline TYPE* get_exception_frame(void) {
    TYPE* frame = nullptr;
#if defined(__arm__)
    asm volatile(
...
__attribute__((always_inline)) inline void interrupt_service_routine_context_save(void) {
#if defined(__arm__)
...
__attribute__((always_inline)) inline void interrupt_service_routine_context_restore(void) {
#if defined(__arm__)
